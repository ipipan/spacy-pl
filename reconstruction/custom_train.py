...
# This file is a customized train.py from spaCy cli,
# the only thing we do different, is the way we initialize the Language class
# this is done so that we can load our custom tag_map instead of using the
# one defined in 'pl' language
